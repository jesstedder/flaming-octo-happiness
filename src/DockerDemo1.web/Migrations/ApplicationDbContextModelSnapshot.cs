...
using DockerDemo1.web.Models;

namespace DockerDemo1.web.Migrations
{
    [ContextType(typeof(DockerDemo1.web.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("DockerDemo1.web.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("DockerDemo1.web.Models.ApplicationUser", "UserId");
                });
